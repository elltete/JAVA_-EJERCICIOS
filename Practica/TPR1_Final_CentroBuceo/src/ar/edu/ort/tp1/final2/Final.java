...
public class Final {
	...
	private static void registrarBuceadorOpenWater(CentroBuceoAvanzado cba, 
			String nombre, String nacionalidad, int edad, int idBuceo) {
		try {
			cba.registrarBuceo(new BuzoOpenWater(nombre, nacionalidad, edad), idBuceo);
		}catch(IllegalArgumentException e){
			System.out.println(e.getMessage());
			cba.agregarErrores(e.getMessage());
		}
	}

	private static void registrarBuceadorAdvanced(CentroBuceoAvanzado cba, 
			String nombre, String nacionalidad, int edad, int idBuceo) {
		try {
	...
	private static void registrarBuceadorTecnico(CentroBuceoAvanzado cba, 
			String nombre, String nacionalidad, int edad, int idBuceo) {
		try {
